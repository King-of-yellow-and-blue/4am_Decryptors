...
const BENIGN_TEMPLATES = [
  (ip: string) =>
    `sshd[${randomInt(1000, 9999)}]: Accepted password for user${randomInt(1, 8)} from ${ip} port ${randomInt(49152, 65535)} ssh2`,
  (ip: string) =>
    `sshd[${randomInt(1000, 9999)}]: Disconnected from user${randomInt(1, 8)} ${ip} port ${randomInt(49152, 65535)}`,
  (ip: string) =>
